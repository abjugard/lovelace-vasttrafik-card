...
| filterMunicipality | boolean | false           | Whether to strip the municipality value from fields                                                                                                      |
...
| stringsToFilter    | list    | []              | Strings to strip before presentation                                                                                                                     |
| language           | string  | null            | User defined language to use in the card. Overrides system lanaguage                                                                                     |
| leaveHomeSuffix    | string  | "&nbsp;minutes" | Text to add to the "Leave home in" column                                                                                                                  |
